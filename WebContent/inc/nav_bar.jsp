<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%><nav role="navigation" class="block block-menu navigation menu--main">

	<nav id="global-nav" class="navbar navbar-expand-lg navbar-dark bg-transparent " role="navigation">
		<div class="container no-override">
			<a class="navbar-brand" href="index.jsp"> <img src="images/logo.png" style="width: 30px; height: 30px;"> TALENTIFY
			</a>
