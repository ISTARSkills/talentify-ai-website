		...
		<section class="container">
			<div class="row">
				...
				<div class="hero-text ">
					...
					<h1 style="color: #fff; font-size: 3em; font-weight: 700" class=" customFadeInUp">WE'RE PASSIONATE ABOUT HELPING PEOPLE BECOME THE VERY BEST THEY CAN BE!</h1>
	...
	<div class="agency-about-team">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="member">
						<a href='https://www.linkedin.com/in/sreeraman-vaidyanathan-bb04854' target="_blank" >
				...
				<div class="col-md-4">
					<div class="member">
						<a href='https://www.linkedin.com/in/surga-thilakan-0196994' target="_blank" >
...
<a href='https://www.linkedin.com/in/vaibhavverma2/' target="_blank" >
				...
				<div class="col-md-4">
					<div class="member">
					    <a href='https://www.linkedin.com/in/paulthomasstartupguru' target="_blank" ></a>
				...
				<div class="col-md-4">
					<div class="member">
					    <a href='https://www.linkedin.com/in/sharath-menon-b5654034' target="_blank" >
				...
				<div class="col-md-4">
					<div class="member">
					<a href='https://www.linkedin.com/in/feroz-siddiqui-653b8628' target="_blank" >
				...
				<div class="col-md-4">
					<div class="member">
					<a href='https://www.linkedin.com/in/abhinav-singh-absin' target="_blank" >
				...
				<div class="col-md-4">
					<div class="member">
					<a href='https://www.linkedin.com/in/vinay-sharma-807058140' target="_blank" >
				...
				<div class="col-md-4">
					<div class="member">
					<a href='https://www.linkedin.com/in/himanshu-arya-551bb915b' target="_blank" >
				...
				<div class="col-md-4">
					<div class="member">
					<a href='https://www.linkedin.com/in/anurag-gupta-a91639103' target="_blank" >
				...
				<div class="col-md-4">
					<div class="member">
					<a href='https://www.linkedin.com/in/sumanth-h-g-09328a112' target="_blank" >
				...
				<div class="col-md-4">
					<div class="member">
					<a href='https://www.linkedin.com/in/abhishek-bajaj-33b92b66' target="_blank" >
				...
				<div class="col-md-4">
					<div class="member">
					<a href='https://www.linkedin.com/in/ravi-g-88a476146' target="_blank" >
				...
				<div class="col-md-4">
					<div class="member">
					<a href='https://www.linkedin.com/in/pb62599a76' target="_blank" >
